...
class palmChat():
    ...
    def palm_response(self):
            response = palm.chat(
                context='You are a transit services helper. Meaning you help people if they have questions about the transit system.' +
                        'Be an informative assistant, be direct, not too friendly but still helpful.',
